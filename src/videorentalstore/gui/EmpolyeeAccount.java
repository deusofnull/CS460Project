 ...
 * @author Ashley
 */
public class EmpolyeeAccount extends javax.swing.JFrame {

    /**
     * Creates new form EmpolyeeAccount
     */
    public EmpolyeeAccount() {
        initComponents();
    }
...
//        directorTxt.setText("");
    ...
    private void rentMoviesLogoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rentMoviesLogoutButtonActionPerformed
        dispose();
    }//GEN-LAST:event_rentMoviesLogoutButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpolyeeAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpolyeeAccount().setVisible(true);
            }
        });
    }
